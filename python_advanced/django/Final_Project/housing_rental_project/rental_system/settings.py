...
SECRET_KEY = 'django-insecure-1m$$fntnl@1v9eh_$9@34e507_e*knm3chw$+z6)pyo+(up$is'
...
REST_FRAMEWORK  = {
    ...
    'DEFAULT_PERMISSION_CLASSES': (
        'rest_framework.permissions.IsAuthenticatedOrReadOnly', #by default, allow read-only access to unauthenticated users
    ),}